<div>
    <section class="w-full min-h-0 mb-24">
        <h2 class="text-3xl text-center my-10">Consolas <i class="fas fa-gamepad"></i></h2>
                ...
                @if (Auth::check())
                    <div href="#" class="w-72 rounded-md group relative block overflow-hidden border-2 border-red-800 p-2">
                        ...
                        <div class="mt-4 relative border border-gray-100 bg-white p-6">
                            ...
                            <h3 class="mt-4 text-lg font-medium text-gray-900">{{  $game->name }}</h3>

                            <p class="mt-1.5 text-2xl text-gray-700">{{  $game->price }} $</p>
